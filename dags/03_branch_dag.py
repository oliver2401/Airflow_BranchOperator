...
with DAG(
    dag_id="pick_data_source_branch_DAG",
    ...
    pick_data_source = BranchPythonOperator(
        task_id="pick_data_source", python_callable=_pick_data_source
    )
    ...
    start >> [pick_data_source, fetch_weather]
    pick_data_source >> [fetch_sales_old, fetch_sales_new]
